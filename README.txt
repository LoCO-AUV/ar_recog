This is the original source of this code: http://wiki.ros.org/ar_recog. It claims to be under GPLv3, but the original source control is no longer available.
